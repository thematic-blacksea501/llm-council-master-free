...
const defaultSettings = {
  ...
  autoDetectLang: true,
  systemPrompt:
    'говори и размышляй на русском. Финальный ответ обязан быть на русском языке! ОБЯЗАН.\n\nИспользуй Markdown для форматирования. Если уместно, используй таблицы или блоки кода. Если не понимаешь вопроса - скажи об этом.',
  chairman: 'Team Elite',
  temperature: 0.7,
  apiKeys: {
    openrouter: '',
